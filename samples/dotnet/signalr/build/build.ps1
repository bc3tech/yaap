...
if (-not $NoDocker) {
    docker rmi -f yaap-signalr-hub yaap-signalr-orchestrator yaap-signalr-districtsagent yaap-signalr-eventsagent yaap-signalr-matchesagent yaap-signalr-teamsagent > $null
    ...
    Start-Job -Name "Image SignalRHub" {
        ...
        docker build -t yaap-signalr-hub $outDir\signalrhub --build-arg SIGNALR_CONNSTRING=$($secret.'Azure:SignalR:ConnectionString')
