...
public static class Constants
{
    public static class Configuration
    {
        ...
        {
            public static readonly string AgentName = ConfigurationPath.Combine("Yaap", "Client", VariableNames.Name);

            public static readonly string AgentDescription = ConfigurationPath.Combine("Yaap", "Client", VariableNames.Description);
        }
    }
