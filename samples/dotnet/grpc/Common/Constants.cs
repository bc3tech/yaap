...
public static class Constants
{
    public static class Configuration
    {
        ...
        public static class VariableNames
        {
            ...
            public const string OrchestratorEndpoint = "Yaap:Server:Endpoint";
        ...
        {
            public static readonly string AgentName = "Yaap:Client:Name";

            public static readonly string AgentDescription = "Yaap:Client:Description";
        }
    }
