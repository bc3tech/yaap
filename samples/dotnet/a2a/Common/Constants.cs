...
public static class Constants
{
    public static class Configuration
    {
        ...
        {
            public static readonly string AgentDefinition = ConfigurationPath.Combine("Yaap", "Client");
        }
        ...
        public static class VariableNames
        {
            ...
            public static readonly string OrchestratorEndpoint = ConfigurationPath.Combine("Yaap", "Server", "Endpoint");
